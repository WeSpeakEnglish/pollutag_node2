...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, DBG3_Pin|SPI_CSN_Pin|LED2_Pin|SPI_CEN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : SPI_CSN_Pin SPI_CEN_Pin */
  ...
  /*Configure GPIO pin : CONNECT_PM_SENSOR_Pin */
